...
export default function StrainSavingForm() {
    ...
    const [strainView, setStrainView] = useState('');
        ...
        <>
            <Formik
                ...
                onSubmit={(values, _helpers) => {
                    ...
                    setStrainView(JSON.stringify(values, undefined, 2));
                }}
            >
                {({ values }) => {
                    ...
                    return (
                        <div className='strain-adding'>
                            <Form className='strain-form form--position-block-center'>
                                <SelectField name='genus.name' label='Род'>
                                    {genusList.map((genus) => (
                                ...
                                <SelectField name='type.name' label='Вид'>
